...
:return: pd.DataFrame"""
	return md_download_hist_price(ticket=ticket,start_date=start_date,end_date=end_date,source=source)
...
:return: pd.DataFrame"""
	return md_get_hist_price(ticket=ticket,start_date=start_date,end_date=end_date,source=source)
...
:return: None"""
	return md_save_hist_price(ticket=ticket,start_date=start_date,end_date=end_date,souece=souece,db_type=db_type)
...
:param db_type: SQL/CSV
:return: None"""
	return md_update_hist_price(ticket=ticket,start_date=start_date,end_date=end_date,souece=souece,db_type=db_type)
...
:return: table contains all information about S&P 500 components"""
	return md_get_sp_comp_stocks_info(rtype=rtype)
